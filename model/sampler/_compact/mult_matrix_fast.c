...
void Mult_Matrix_Fast_Sample(int *ZSDS, int *WSZS, double *Phi, double *Theta, int *pr, int *ir, int *jc, int Vsize, int Nsize, int Ksize,  double *prob_cumsum)
{
    
    double cum_sum, probrnd;
    int k, j, v, token, total=0;
